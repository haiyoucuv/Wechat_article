...
# 《塞尔达》怪物为何比你还秀？几行 A* 代码，帮你的 NPC 装上“最强大脑”

![title.png](images/title.png)

## 引言

你是否曾在《塞尔达传说》里被莫力布林追得满地找牙？即使你钻进再刁钻的犄角旮旯，这些家伙也能像开了挂一样，绕过错综复杂的障碍物精准堵人。

再看看自家游戏里的 NPC，是不是还在对着墙壁疯狂“摩擦”？先别急着骂 AI 笨，它们可能只是缺一位运筹帷幄的“顶级军师”。

这个公式统治了游戏寻路领域整整 50 年。它是《暗黑破坏神》里那丝滑的自动点击寻路，也是《星际争霸》里百人大战不撞车的底层秘密。

今天，咱们就来揭秘这款游戏界的“导航之王”——**A* 寻路算法**（A-Star）。带你在 **Cocos Creator** 里手撸一套完整的可视化寻路系统，让你的 NPC 摆脱“撞了南墙不回头”的尴尬，瞬间拥有“走位大师”的灵魂。
